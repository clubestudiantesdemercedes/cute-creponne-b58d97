...
export const seedDemoData = createServerFn({ method: 'POST' }).handler(async () => {
  ...
  const [convenioXYZ, convenioComercio, convenioMunicipal] = await db
    .insert(conventions)
    .values([
      {
  ...
  const demoMembers = [
    { num: '00101', dni: '30100001', first: 'Juan', last: 'Pérez' },
    { num: '00102', dni: '30100002', first: 'María', last: 'González' },
    { num: '00103', dni: '30100003', first: 'Carlos', last: 'Fernández' },
    { num: '00104', dni: '30100004', first: 'Lucía', last: 'Martínez' },
    { num: '00105', dni: '30100005', first: 'Pedro', last: 'López' },
    { num: '00106', dni: '30100006', first: 'Ana', last: 'Rodríguez' },
  ...
  const demoNonMembers = [
    { dni: '35200001', first: 'Rodrigo', last: 'Ibáñez' },
    { dni: '35200002', first: 'Camila', last: 'Acosta' },
    { dni: '35200003', first: 'Federico', last: 'Molina' },
  ...
  for (const spec of demoSalesSpec) {
    ...
    if (spec.daysAgo <= 5) {
      await db.insert(entries).values({
        ...
        method: 'manual',
        occurredAt: new Date(purchaseDate + 'T16:30:00'),
      })
    }
  }
